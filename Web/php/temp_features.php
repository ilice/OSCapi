...
$sw_coordinates = array($sw_lat, $sw_lng);
$nw_coordinates = array($ne_lat, $sw_lng);
$ne_coordinates = array($ne_lat, $ne_lng);
$se_coordinates = array($sw_lat, $ne_lng);

$ring_coordinates = array($sw_coordinates, $se_coordinates,$ne_coordinates, $nw_coordinates,$sw_coordinates);
...
function dropCoordinates($coordinates) {
	...
	foreach ($coordinates as $pairOfCoordinates){
		if(isACoordinatesPair($pairOfCoordinates)){
			array_push($droppedCoordinates, array ($pairOfCoordinates[1], $pairOfCoordinates[0]));
		}else{
